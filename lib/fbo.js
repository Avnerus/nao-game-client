...
exports default class FBO {
    constructor() {
        console.log("FBO Constructed")
    }
    init = function( width, height, renderer, simulationMaterial, renderMaterial ) {
    ...
    update = function(){
        ...
        this.renderer.render( scene, orthoCamera, rtt, true );

        //2 use the result of the swap as the new position for the particles' renderer
        this.particles.material.uniforms.positions.value = rtt;
